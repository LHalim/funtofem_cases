...
from pyfuntofem.fun3d_interface_test_complex import *
...
#        var[1] += h*1j
        ...
        self.cruise_drag = functions[2].value# * 2.0 * self.cruise_q
        ...
        #obj = self.c1 * TOGW
        obj = temp#self.cruise_drag
        print("%s %.10E"%('Forward Temp: ',temp.real))
        print("%s %.30E"%('Forward Temp grad: ',temp.imag/h))
        print("%s %.10E"%('Forward Lift: ',self.cruise_lift.real))
        print("%s %.30E"%('Forward Lift grad: ',self.cruise_lift.imag/h))
        print("%s %.10E"%('Forward Drag: ',self.cruise_drag.real))
        print("%s %.30E"%('Forward Drag grad: ',self.cruise_drag.imag/h))
